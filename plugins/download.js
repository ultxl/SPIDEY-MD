            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "𝙱𝚄𝙼𝙱𝙻𝙴𝙱𝙴𝙴 | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *𝙱𝚄𝙼𝙱𝙻𝙴 *\n\n> ©>𝙱𝙴𝙴"
                }, {
                  'quoted': _0x171143
                });
              } else {
